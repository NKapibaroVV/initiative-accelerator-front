...
function MainPage() {
    return <>
        <div className="my-2">
            ...
            <h3 className="border-bottom border-3 border-white pb-1 mb-3">Система роста</h3>

            <div className="rounded-4 p-3 bg-dark-1 my-3">
            ...
            <div className="rounded-4 p-3 bg-dark-1">
                <div className="fw-bold">Член МСОПР</div>
                <div className="rounded-4 p-3 bg-dark-1 mx-2">
            ...
            <h3 className="border-bottom border-3 border-white pb-1 my-3">Работа с заданиями</h3>
            ...
            <h3 className="border-bottom border-3 border-white pb-1 my-3">Условия при работе с заданиями</h3>
