...
export default function NotifContainer() {
    ...
    return <><button className={`navbar-toggler`} type="button" style={{ marginLeft: "auto", marginRight: "10px", width: "56px", height: "40px" }} data-bs-toggle="offcanvas" data-bs-target="#offcanvasNotif" aria-controls="offcanvasNotif">
